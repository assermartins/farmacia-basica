...
/**
 * The persistent class for the saidas_medicamentos database table.
 * 
 */
@Entity
@Table(name="saidas_medicamentos")
@NamedQuery(name="SaidasMedicamento.findAll", query="SELECT s FROM SaidasMedicamento s")
